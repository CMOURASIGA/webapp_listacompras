...
export default function HelpMenu({
  ...
  return (
    <aside className="bg-white border border-gray-200 rounded-3xl p-3 h-fit md:sticky md:top-24">
      ...
      <div className="flex md:flex-col gap-2 overflow-x-auto md:overflow-visible pb-1 md:pb-0">
        {guides.map((guide) => (
          <button
            ...
            className={`min-w-[220px] md:min-w-0 w-full text-left px-3 py-3 rounded-2xl border transition-all ${
